...
def model_prediction(test_image):
    ...
    predicted_index = np.argmax(predictions)  # Index of max element
    confidence = predictions[0][predicted_index]  # Probability of the predicted class
...
# Prediction Page
    ...
    if st.button("Predict"):
        ...
        class_name = ['Apple___Apple_scab', 'Apple___Black_rot', 'Apple___Cedar_apple_rust', 'Apple___healthy',
                      ...
                      'Tomato___healthy']
        st.success(f"Model is predicting it's {class_name[result_index]} with a confidence of {confidence:.2%}")
